...
public class AuthorityServiceTest {
    ...
    private static final String AUTHORITY_JSON_SAMPLE =
            "{\"authorities\": [" +
                    "    {" +
    ...
    public void before() throws IOException {
        ...
        when(httpClient.getAuthoritiesJsonString()).thenReturn(AUTHORITY_JSON_SAMPLE);
        authorityService = new AuthorityService(httpClient);

    }

    @Test
    public void shouldReturnAuthorities() throws IOException {
